...
public class API {
    ...
    public static void main(String[] args) {
        ...
        //				.convertCookies("[DedeUserID=xxx; DedeUserID__ckMd5=xxx; SESSDATA=xxx; bili_jct=xxx;
        // bfe_id=xxx...]");
    ...
    public static boolean like(long avIdNum) {
        /**
         * 是否已经点赞 https://api.bilibili.com/x/web-interface/archive/has/like?aid=666
         * {"code":0,"message":"0","ttl":1,"data":1} 已经点赞 {"code":0,"message":"0","ttl":1,"data":0}
         * 没有点赞
         */
        HttpRequestUtil util = new HttpRequestUtil();
        String url_query =
                "https://api.bilibili.com/x/web-interface/archive/has/like?aid=" + avIdNum;
        ...
        if (result_query.startsWith("{\"code\":0,\"message\":\"0\",\"ttl\":1,\"data\":0}")) {
            ...
            if (result.startsWith("{\"code\":0")) return true;
        }
        return false;
    }
    ...
    public static void logout() {
        ...
        String result =
                util.postContent(
                        url,
                        new HttpHeaders().getLogoutHeaders(),
                        param,
                ...
                if (wbiImg == null) {
                    ...
                    String content =
                            util.getContent(
                                    ...
                                    new HttpHeaders().getCommonHeaders(),
                                    HttpCookies.getGlobalCookies());
                    JSONObject obj =
                            new JSONObject(content).getJSONObject("data").getJSONObject("wbi_img");
    ...
    static final long SECONDS_OF_ONE_YEAR = 60 * 60 * 24 * 365;
        ...
        if (fingerprint.exists()) {
            ...
            if (!cookie.contains("i-wanna-go-back") || currentTime - b_nut > SECONDS_OF_ONE_YEAR) {
                ...
                if (time + 5400000L < currentTime) {
                    String b_lsid =
                            ResourcesUtil.randomHex(8)
                                    + "_"
                                    + Long.toHexString(currentTime).toUpperCase();
    ...
    public static void uploadFingerprint() {
        ...
        if (time + 5400000L < currentTime) {
            String b_lsid =
                    ResourcesUtil.randomHex(8) + "_" + Long.toHexString(currentTime).toUpperCase();
        ...
        payload =
                payload.replaceFirst(
                        "\"b8ce\":\"[^\"]+\"", "\"b8ce\":\"" + Global.userAgent + "\"");
        payload =
                payload.replaceFirst(
                        "\"df35\":\"[^\"]+\"", "\"df35\":\"" + HttpCookies.get("_uuid") + "\"");
    ...
    public static String genNewFingerprint() {
        try {
            ...
            HttpURLConnection conn =
                    (HttpURLConnection) new URL("https://www.bilibili.com/").openConnection();
            ...
            String _uuid =
                    new StringBuilder()
                            .append(ResourcesUtil.randomHex(8))
                            .append("-")
                            .append(ResourcesUtil.randomHex(4))
                            .append("-")
                            .append(ResourcesUtil.randomHex(4))
                            .append("-")
                            .append(ResourcesUtil.randomHex(4))
                            .append("-")
                            .append(ResourcesUtil.randomHex(18))
                            .append("infoc")
                            .toString();
    ...
    public static String genDmImgParams() {
        ...
        String _wh =
                f114(
                        Integer.parseInt(mResolution.group(1)),
                        Integer.parseInt(mResolution.group(2)));
        String _of = f514(0, 0);
        ...
        return String.format(
                "&dm_img_list=%s&dm_img_str=%s&dm_img_inter=%s&dm_cover_img_str=%s",
                dm_img_list, dm_img_str, dm_img_inter, dm_cover_img_str);
    }
}
