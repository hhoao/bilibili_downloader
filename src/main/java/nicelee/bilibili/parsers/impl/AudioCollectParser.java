...
public class AudioCollectParser extends AbstractPageQueryParser<VideoInfo> {
    ...
    private static final Pattern pattern = Pattern.compile("/audio/mycollection/([0-9]+)");
    private String sid;
    ...
    protected boolean query(int page, int min, int max, Object... obj) {
        try {
            ...
            if (pageQueryResult.getVideoName() == null) {
                String url =
                        "https://www.bilibili.com/audio/music-service-c/web/collections/info?sid="
                                + sid;
            ...
            String urlFormat =
                    "https://www.bilibili.com/audio/music-service-c/web/song/of-coll?sid=%s&pn=%d&ps=%d";
