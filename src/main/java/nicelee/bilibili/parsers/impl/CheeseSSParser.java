...
public class CheeseSSParser extends AbstractPageQueryParser<VideoInfo> {
    ...
    protected boolean query(int page, int min, int max, Object... obj) {
        try {
            ...
            String urlFormat =
                    "https://api.bilibili.com/pugv/view/web/ep/list?season_id=%s&pn=%d&ps=%d";
    ...
    public int[] getVideoQNList(String avId, String cid, String epId) {
        String urlFormat =
                "https://api.bilibili.com/pugv/player/web/playurl?avid=%s&cid=%s&bvid=&qn=%d&type=&otype=json&ep_id=%s&fourk=1&fnver=0&fnval=80";
    ...
    public String getVideoLink(String ssId, String cid, int qn, int downFormat) {
        ...
        try {
            HashMap<String, String> headerDownload =
                    new HttpHeaders().getBiliWwwM4sHeaders("av" + avID);
