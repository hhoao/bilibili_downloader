...
public class FFmpegParser extends AbstractBaseParser {
    ...
    private String getDownUrl() {
        ...
        url =
                url.replace("{os}", SysUtil.getOS())
                        .replace("{arch}", SysUtil.getARCH())
                        .replace("{exeSuffix}", SysUtil.getEXE_SUFFIX());
        return url;
    }
    ...
    public VideoInfo result(String input, int videoFormat, boolean getVideoLink) {
        ...
        vInfos.setVideoPreview(
                "http://i2.hdslb.com/bfs/archive/0975f9fe3ec5a65b983f43bc437b8f5698e4ea8a.jpg");
