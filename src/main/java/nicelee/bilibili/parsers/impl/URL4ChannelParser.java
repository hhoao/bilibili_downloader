...
/**
 * 这是老版的channel解析，针对的是如下类型的url https://space.bilibili.com/378034/channel/detail?cid=189
...
public class URL4ChannelParser extends AbstractPageQueryParser<VideoInfo> {
    ...
    private static final Pattern pattern =
            Pattern.compile("space\\.bilibili\\.com/([0-9]+)/channel/detail\\?cid=([0-9]+)");
    ...
    protected boolean query(int page, int min, int max, Object... obj) {
        ...
        try {
            String urlFormat =
                    "https://api.bilibili.com/x/space/channel/video?mid=%s&cid=%s&pn=%d&ps=%d&order=0";
            ...
            if (pageQueryResult.getVideoName() == null) {
                ...
                pageQueryResult.setAuthor(
                        arr.getJSONObject(0).getJSONObject("owner").getString("name"));
