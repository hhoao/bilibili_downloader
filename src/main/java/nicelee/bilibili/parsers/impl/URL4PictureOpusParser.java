 ...
 * 下载图文动态里面的图片
 *
 * <p>https://www.bilibili.com/opus/953619104940425225
 *
 * <p>https://m.bilibili.com/opus/953839801850658840
 *
 * <p>https://t.bilibili.com/953619104940425225
 */
...
public class URL4PictureOpusParser extends URL4PictureCVParser {
    ...
    protected VideoInfo getOpusDetail(String opusIdNumber) {
        ...
        if (jTopPics != null) {
            for (int i = 0; i < jTopPics.length(); i++) {
                ...
                ClipInfo clip =
                        newCommonClip(opusIdStr, viInfo, author, authorId, cTime, null, null);
    ...
    //		JSONObject jDynamic =
    // jObj.getJSONObject("module_dynamic").getJSONObject("major").getJSONObject("opus");
    //
    //		// 总体大致信息
