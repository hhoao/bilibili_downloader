...
public class ResourcesUtil {
    ...
    public static File baseDirFile() {
        if (cacheBaseDirFile == null) cacheBaseDirFile = new File(baseDirectory());
        ...
        if (cacheBaseDir == null) {
            ...
            if (isJarLaunch) {
                try {
                    ...
                    if (path == null || "".equals(path)) cacheBaseDir = getProjectPath();
                    else cacheBaseDir = java.net.URLDecoder.decode(path, "UTF-8");
