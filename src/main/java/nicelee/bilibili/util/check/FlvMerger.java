...
public class FlvMerger {
    ...
    public static void main(String[] args) throws IOException {
        ...
        File f1 =
                new File(
                        "D:\\Workspace\\javaweb-springboot\\BilibiliDown\\download\\BV1Ss411h7Ge-80-p7-part1.flv");
        File f2 =
                new File(
                        "D:\\Workspace\\javaweb-springboot\\BilibiliDown\\download\\BV1Ss411h7Ge-80-p7-part2.flv");
        File f3 =
                new File(
                        "D:\\Workspace\\javaweb-springboot\\BilibiliDown\\download\\BV1Ss411h7Ge-80-p7-part3.flv");
        flist.add(f1);
        flist.add(f2);
        flist.add(f3);
