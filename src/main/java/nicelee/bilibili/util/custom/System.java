...
public class System {
    ...
    public static void init(boolean isToInitiate) {
        ...
        try {
            ...
            long remoteTime =
                    new JSONObject(timeResult).getJSONObject("data").getLong("now") * 1000;
    ...
    public static long currentTimeMillis() {
        if (initiated) return java.lang.System.currentTimeMillis() + deltaRemoteSubLocal;
        else return java.lang.System.currentTimeMillis();
    }
