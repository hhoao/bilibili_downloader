...
public class PathDealer {
    ...
    private Method findMethod(String path, Method currentMethod) {
        for (Class<?> klass : PackageScanLoader.controllerClazzes) {
            ...
            for (Method method : klass.getMethods()) {
                ...
                if (controller != null
                        && (controller.specificPath().isEmpty() || !controller.path().isEmpty())) {
     ...
     * @param headersMap
     */
    private void dealWithPathKnown(
            BufferedWriter out,
            OutputStream outRaw,
            String path,
            String param,
     ...
     * @throws IOException
     */
    private void dealWithPathUnknown(BufferedWriter out, String path, boolean isCmd)
            throws IOException {
