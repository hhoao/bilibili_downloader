...
public class DialogSMSLogin extends JDialog
    ...
    public void init() {
        ...
        initSysButton(panel);
        ImageIcon icon = new ImageIcon(DialogSMSLogin.class.getResource("/banner.jpg"));
    ...
    public void login() {
        ...
        if (code.isEmpty()) lbTips.setText("短信验证码不能为空");
        else {
    ...
    public void sendSMS(String token, String challenge, String validate, String seccode) {
        ...
        try {
            JSONObject obj =
                    inl.sendSMS(countryCode, phoneNumber, token, challenge, validate, seccode);
    ...
    public void mouseClicked(MouseEvent e) {
        if (e.getSource() == lbGetSMS) {
            ...
            if (m.find()) {
                ...
                queryCaptcha();
            } else lbTips.setText("手机号不符合+国际号 手机号码的格式(注意中间的空格)");
