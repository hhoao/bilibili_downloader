...
public class TabSettings extends JPanel implements ActionListener {
    ...
    static final int LINE_HEIGHT = 32, H_GAP = 5, V_GAP = 5;
    JPanel jpContent;
        ...
        label.addMouseListener(
                new MouseAdapter() {
                    ...
                    public void mouseClicked(MouseEvent e) {
                        if (e.getClickCount() >= 2) Global.tabs.remove(panel);
                        else Global.tabs.setSelectedComponent(panel);
                    }
                });
    }
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        if (ConfigUtil.saveConfig()) {
                            JOptionPane.showMessageDialog(
                                    null, "保存成功", "OK", JOptionPane.INFORMATION_MESSAGE);
                            resetJPanel();
                        } else {
                            JOptionPane.showMessageDialog(
                                    null, "保存失败", "!", JOptionPane.ERROR_MESSAGE);
                        }
                    }
                });
    ...
    private void updateSettingsUI() {
        ...
        final Dimension sBoxDim = new Dimension(sBoxWidth, LINE_HEIGHT),
                ...
                txtValueDimWithbtnChooser =
                        new Dimension(txtValueWidth - btnChooserWidth, LINE_HEIGHT),
                ...
                if (!note.isEmpty()) {
                    ...
                    if (selects.length > 0) {
                                ...
                                new ItemListener() {
                                    ...
                                    public void itemStateChanged(ItemEvent e) {
                                        if (e.getStateChange() == ItemEvent.SELECTED) {
                                            onContentChanged(
                                                    name, e.getItem().toString(), selected);
                                        }
                                    }
                                });
                        JLabel blank =
                                this.createTextLabel(null, totalWidth - sBoxWidth, LINE_HEIGHT);
                        ...
                        if (withBtnChooser) {
                            ...
                            btnFileChooser.addActionListener(
                                    evt -> {
                                        JFileChooser fChooser = new JFileChooser(value.getText());
                                        //								fChooser.setCurrentDirectory(new
                                        // File(value.getText()));
