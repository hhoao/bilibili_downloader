...
public class TabVideo extends JPanel implements ActionListener, MouseListener {
    ...
    public void init() {
        ...
        // ImageIcon imag1 = new
        // ImageIcon(this.getClass().getResource("/loading.gif"));
        ...
        //			imgIcon = new ImageIcon(imgIcon.getImage().getScaledInstance(450, 450,
        // Image.SCALE_SMOOTH));
    ...
    //		g.drawImage(backgroundIcon.getImage(), 0, 0, this.getSize().width, this.getSize().height,
    // this.getParent());
    //		this.setOpaque(false);
    //	}
    @Override
