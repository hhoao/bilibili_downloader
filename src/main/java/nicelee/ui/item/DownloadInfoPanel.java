...
public class DownloadInfoPanel extends JPanel implements ActionListener {
        ...
        if (e.getSource() == btnOpenFolder) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(
                        null, "打开文件夹失败!", "失败", JOptionPane.INFORMATION_MESSAGE);
            }
            ...
            try {
                ...
                // e1.printStackTrace();
                JOptionPane.showMessageDialog(
                        null, "打开文件失败!", "失败", JOptionPane.INFORMATION_MESSAGE);
            }
        } else if (e.getSource() == btnRemove) {
            //			if(Global.downloadTaskList.get(this).getStatus() == 0) {
            //				JOptionPane.showMessageDialog(this, "当前正在文件下载中!", "警告",
    ...
    /** 下载前的初始化工作 */
    public void initDownloadParams(
            INeedAV iNeedAV, String url, String avid_qn, String formattedTitle, int realqn) {
        ...
        if (status != StatusEnum.DOWNLOADING
            ...
            if (!Global.downLoadThreadPool.isShutdown()) {
                Global.downLoadThreadPool.execute(
                        new DownloadRunnableInternal(
                                this, System.currentTimeMillis(), true, failCnt));
            }
        }
    }
