...
public class BatchDownloadRbyRThread extends BatchDownloadThread {
    ...
    static final SimpleDateFormat sdfToday = new SimpleDateFormat("yyyy-MM-dd");
    ...
    public BatchDownloadRbyRThread(String configFileName) {
        ...
        this.setDaemon(true);
        // String plan = "06:00~02:00=>r(300,480); 02:00~04:00=>~06:00+r(0,360);
        // 00:00~00:00=>r(30,30)";
        ...
        try {
            ...
            while (true) {
                ...
                if (Global.downloadTab.activeTask == 0) {
                    ...
                    if (Global.isLogin
                            && !Global.runWASMinBrowser
                            && currentTime - lastCookieRefreshTime > MILLI_SECONDS_OF_ONE_DAY) {
    ...
    public static void main(String[] a) {
        try {
            ...
            String plan =
                    "06:00~02:00=>r(300,480); 02:00~04:00=>~06:00+r(0,360); 00:00~00:00=>r(30,31)";
            ...
            System.out.println("-----------------------------");
            curTime =
                    sdf.parse("2024-01-21 02:01")
                            .getTime(); // 到2024-01-21 06:01 有239min 再加上 [0~360)s
    ...
    static final long MILLI_SECONDS_OF_ONE_DAY = 1000 * 60 * 60 * 24;
    static final Pattern rollTimePattern = Pattern.compile("r\\(([0-9]+),([0-9]+)\\)");
    static final Pattern toTimePattern = Pattern.compile("~([0-9]{2}:[0-9]{2})");
    /**
     * 06:00~02:00=>r(300,480); 02:00~04:00=>~06:00+r(0,360); 00:00~00:00=>r(30,30)
     *
     * <p>北京时间、时间都是闭区间、roll点是左闭右开、左边优先级最高
     *
     * <p>每天早上6点到第二天早上2点(但实际只包括当天剩余时间，即到第二天零点为止)，随机300s~480s(5~8min)
     *
     * <p>每天早上2点到早上4点，sleep到早上6点再加一个随机时间 0s~480s(0~6min)
     *
     * <p>其它时间，固定30s
     *
