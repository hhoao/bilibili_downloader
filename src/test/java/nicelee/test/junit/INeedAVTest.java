...
public class INeedAVTest {
    ...
    public void testDownloadDanmuku() {
        ...
        //		downloader.download("https://api.bilibili.com/x/v1/dm/list.so?oid=85464878",
        // "av48804637", 80, 1);
        String danmuku =
                util.getContent(
                        "http://comment.bilibili.com/85464878.xml",
                        new HttpHeaders().getDanmuHeaders(),
                        null);
    ...
    public void testGetAvInfoOnlyOnPhone() {
        ...
        HttpRequestUtil util = new HttpRequestUtil();
        String url =
                "http://upos-hz-mirrorbosu.acgvideo.com/upgcxcode/54/61/3876154/3876154-1-32.flv?e=ig8euxZM2rNcNbNV7zUVhoMghwuBhwdEto8g5X10ugNcXBlqNCNEto8g5gNvNE3DN0B5tZlqNxTEto8BTrNvN05fqx6S5ahE9IMvXBvE2ENvNCImNEVEK9GVqJIwqa80WXIekXRE9IB5QK==&deadline=1561830248&gen=playurl&nbs=1&oi=1961292611&os=bosu&platform=android&trid=e49a2ef9a77e4a028f3924c54470a632&uipk=5&upsig=d8f54521d15c8db8898dad58eb7ace15&uparams=e,deadline,gen,nbs,oi,os,platform,trid,uipk&mid=0";
