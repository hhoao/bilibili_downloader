...
public class ParserTest {
    ...
    public void testAVParser() {
        ...
        if (!video.getVideoPreview()
                .equals(
                        "http://i1.hdslb.com/bfs/archive/b04c8df57dea36b283865fca73be6a198e21c94c.jpg")) {
    ...
    public void testEPParser() {
        ...
        assertEquals(
                "http://i0.hdslb.com/bfs/archive/3fe329f522a85c92d142db623d3fc5787efdf8a2.jpg",
    ...
    public void testGetSsInfo() {
        ...
        if (!video.getVideoPreview()
                .equals(
                        "https://i0.hdslb.com/bfs/bangumi/a92892921f3209f7784a954c37467c9869a1d4c1.png")) {
            fail("VideoPreview Link Not Expected");
        }
    ...
    /** 测试解析UP主 个人特定频道 https://space.bilibili.com/546195/channel/detail?cid=21838 */
    // @Test
    public void testAVList4Channel() {
        ...
        String result =
                (parser.validStr("https://space.bilibili.com/546195/channel/detail?cid=21838 p=1"));
        assertEquals(" av12083728 av12388205 av12845082 av13480868", result);
    }

    /** 测试解析UP主 所有视频 https://space.bilibili.com/5276/video */
    // @Test
    ...
    /** https://h.bilibili.com/44254262 URL4PictureParser */
    @Test
    public void testURL4PictureParser() {
        ...
        String path =
                "D:\\Workspace\\javaweb-springboot\\BilibiliDown\\download\\h43603721-0-p2.jpg";
